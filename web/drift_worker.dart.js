...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    QueryResult_QueryResult$fromRows(rows) {
      var keys, t1, t2, _i, row, t3, t4, _i0;
      if (rows.length === 0)
        return A.QueryResult$(B.List_empty, B.List_empty1);
      ...
      for (t2 = rows.length, _i = 0; _i < rows.length; rows.length === t2 || (0, A.throwConcurrentModificationError)(rows), ++_i) {
        row = rows[_i];
        t3 = [];
        for (t4 = keys.length, _i0 = 0; _i0 < keys.length; keys.length === t4 || (0, A.throwConcurrentModificationError)(keys), ++_i0)
    ...
    _containsImpl(args) {
      ...
      return argCount === 3 && args.$index(0, 2) === 1 ? B.JSString_methods.contains$1(first, second) : B.JSString_methods.contains$1(first.toLowerCase(), second.toLowerCase());
    },
    ...
    WebPortToChannel_channel(_this) {
      ...
      new A._ControllerStream(t4, A._instanceType(t4)._eval$1("_ControllerStream<1>")).listen$2$onDone(new A.WebPortToChannel_channel_closure0(false, protocol, _this), new A.WebPortToChannel_channel_closure1(false, _this));
      return t1;
    },
    ...
    _WasmDelegate: function _WasmDelegate(t0, t1, t2, t3, t4, t5, t6) {
      var _ = this;
      _._sqlite3 = t0;
      _._path = t1;
      _._fileSystem = t2;
      ...
      _.enableMigrations = t5;
      _._preparedStmtsCache = t6;
    ...
    _extension_0_runWithArgsAndSetResult(_this, $function, args) {
      var e, exception, encoded, t1, ptr,
        dartArgs = new A.ValueList(args, A.List_List$filled(args.length, null, false, type$.nullable_Object));
      try {
        ...
        t1 = t1.sqlite3;
        t1.sqlite3_result_error(_this.context, ptr, encoded.length);
        t1.dart_sqlite3_free(ptr);
      } finally {
      }
    },
    _extension_0_setResult(_this, result) {
      var t1, encoded, t2, ptr, _this0;
      $label0$0: {
        t1 = null;
        if (result == null) {
          _this.bindings.sqlite3.sqlite3_result_null(_this.context);
          break $label0$0;
        }
        if (A._isInt(result)) {
          _this.bindings.sqlite3.sqlite3_result_int64(_this.context, type$.JavaScriptBigInt._as(init.G.BigInt(A._BigIntImpl__BigIntImpl$from(result).toString$0(0))));
          break $label0$0;
        }
        if (result instanceof A._BigIntImpl) {
          _this.bindings.sqlite3.sqlite3_result_int64(_this.context, type$.JavaScriptBigInt._as(init.G.BigInt(A.BigIntRangeCheck_get_checkRange(result).toString$0(0))));
          break $label0$0;
        }
        if (typeof result == "number") {
          _this.bindings.sqlite3.sqlite3_result_double(_this.context, result);
          break $label0$0;
        }
        if (A._isBool(result)) {
          _this.bindings.sqlite3.sqlite3_result_int64(_this.context, type$.JavaScriptBigInt._as(init.G.BigInt(A._BigIntImpl__BigIntImpl$from(result ? 1 : 0).toString$0(0))));
          break $label0$0;
        }
        if (typeof result == "string") {
          ...
          t2 = t2.sqlite3;
          t2.sqlite3_result_text(_this.context, ptr, encoded.length, -1);
          t2.dart_sqlite3_free(ptr);
          break $label0$0;
        }
        t2 = type$.List_int;
        if (t2._is(result)) {
          t2._as(result);
          t2 = _this.bindings;
          ptr = t2.allocateBytes$1(result);
          t2 = t2.sqlite3;
          t2.sqlite3_result_blob64(_this.context, ptr, type$.JavaScriptBigInt._as(init.G.BigInt(J.get$length$asx(result))), -1);
          t2.dart_sqlite3_free(ptr);
          break $label0$0;
        }
        if (type$.Record_2_nullable_Object_and_int._is(result)) {
          A._extension_0_setResult(_this, result._0);
          _this0 = result._1;
          t2 = type$.nullable_JavaScriptFunction._as(_this.bindings.sqlite3.sqlite3_result_subtype);
          if (t2 != null)
            t2.call(null, _this.context, _this0);
          break $label0$0;
        }
    ...
    BaseVirtualFileSystem_generateRandomness(target) {
      var t1, i, t2,
    ...
    Sqlite3Filename: function Sqlite3Filename() {
    },
    ...
    WrappedMemory_copyRange(_this, pointer, $length) {
      ...
      B.NativeUint8List_methods.setAll$2(list, 0, A.NativeUint8List_NativeUint8List$view(type$.NativeArrayBuffer._as(_this.buffer), pointer, $length));
      return list;
    },
    _InjectedValues$() {
      var t1 = type$.int;
    ...
    createExceptionRaw(bindings, db, returnCode, operation, previousStatement, statementArgs) {
      var t5, _null = null,
        ...
        _0_0 = t4 == null ? _null : A._asInt(A._asDouble(t4.call(null, t2)));
      if (_0_0 == null)
        _0_0 = -1;
      $label0$0: {
        if (_0_0 < 0) {
      ...
      return new A.SqliteException(A.WrappedMemory_readString(t1.memory, A._asInt(t3.sqlite3_errmsg(t2)), _null), A.WrappedMemory_readString(t5.memory, A._asInt(t5.sqlite3.sqlite3_errstr(extendedCode)), _null) + " (code " + extendedCode + ")", returnCode, t4, operation, previousStatement, statementArgs);
    },
    ...
    ReadDartValue_read(_this) {
      var t4, $length,
        t1 = _this.bindings,
        t2 = _this.value,
        t3 = t1.sqlite3,
        _0_0 = A._asInt(t3.sqlite3_value_type(t2));
      $label0$0: {
        t4 = null;
        if (1 === _0_0) {
          t1 = A._asInt(A._asDouble(init.G.Number(type$.JavaScriptBigInt._as(t3.sqlite3_value_int64(t2)))));
          break $label0$0;
        }
        if (2 === _0_0) {
          t1 = A._asDouble(t3.sqlite3_value_double(t2));
          break $label0$0;
        }
        if (3 === _0_0) {
          $length = A._asInt(t3.sqlite3_value_bytes(t2));
          t1 = A.WrappedMemory_readString(t1.memory, A._asInt(t3.sqlite3_value_text(t2)), $length);
          break $label0$0;
        }
        if (4 === _0_0) {
          $length = A._asInt(t3.sqlite3_value_bytes(t2));
          t1 = A.WrappedMemory_copyRange(t1.memory, A._asInt(t3.sqlite3_value_blob(t2)), $length);
          break $label0$0;
        }
        t1 = t4;
        break $label0$0;
  ...
  A._CastListBase.prototype = {
    ...
    setRange$4(_, start, end, iterable, skipCount) {
      var t1 = this.$ti;
      J.setRange$4$ax(this.__internal$_source, start, end, A.CastIterable_CastIterable(t1._eval$1("Iterable<2>")._as(iterable), t1._rest[1], t1._precomputed1), skipCount);
    },
  ...
  A.SetBase.prototype = {
    ...
    get$first(_) {
      var t1,
        it = A._LinkedHashSetIterator$(this, this._modifications, this.$ti._precomputed1);
      if (!it.moveNext$0())
        throw A.wrapException(A.IterableElementError_noElement());
  ...
  A.DriftProtocol.prototype = {
    ...
    decodePayload$1(encoded) {
      var t1, tag, readInt, readNullableInt, method, sql, args, t2, i, list, t3, t4, t5, _1_0, updates, encodedUpdate, _2_0, columnCount, columns, rows, result, t6, rowOffset, t7, c, _null = null, _box_0 = {};
      if (encoded == null)
        return _null;
  ...
  A.ServerImplementation.prototype = {
    ...
    _closeRemainingConnections$0() {
      var t1, t2, t3;
      for (t1 = this._activeChannels, t1 = A._LinkedHashSetIterator$(t1, t1._modifications, t1.$ti._precomputed1), t2 = t1.$ti._precomputed1; t1.moveNext$0();) {
  ...
  A._StatementBasedTransactionExecutor.prototype = {
    ...
    beginTransactionInContext$1(context) {
      var t1 = this.depth + 1;
      return new A._StatementBasedTransactionExecutor(this._engines$_delegate, new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void), context, t1, A._defaultSavepoint(t1), A._defaultRelease(t1), A._defaultRollbackToSavepoint(t1), this._db, new A.Lock());
    },
    send$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait($async$self.runCustom$2($async$self._commitCommand, B.List_empty0), $async$send$0);
            case 3:
              // returning from await.
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 3;
              $async$goto = 6;
              return A._asyncAwait($async$self.runCustom$2($async$self._rollbackCommand, B.List_empty0), $async$rollback$0);
            case 6:
              // returning from await.
              $async$next.push(5);
              // goto finally
  ...
  A.DelegatedDatabase_ensureOpen_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, e, s, t2, _0_0, t3, t4, exception, t1, $async$exception;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
          $async$errorStack.push($async$result);
          $async$goto = $async$handler;
      ...
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$self.opened.complete$1(true);
              t1 = $async$self.$this;
              $async$goto = 2;
  ...
  A.Sqlite3Delegate.prototype = {
    ...
    runBatchSync$1(statements) {
      var stmt, application, stmt0, stmt1, t1, t2, _i, t3, t4, t5, t6,
        prepared = A._setArrayType([], type$.JSArray_CommonPreparedStatement);
      try {
        for (t1 = J.get$iterator$ax(statements.statements); t1.moveNext$0();) {
          stmt = t1.get$current();
        ...
        for (t1 = statements.$arguments, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
          ...
          t5 = t3.finalizable;
          if (t5._statement$_closed)
            A.throwExpression(A.StateError$(string$.Tried_));
          if (!t5._inResetState) {
            t6 = t5.statement;
            A._asInt(t6.bindings.sqlite3.sqlite3_reset(t6.stmt));
        ...
        for (t1 = prepared, t2 = t1.length, t3 = type$.StatementImplementation, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
          ...
          if (!t5._statement$_closed) {
            ...
            if (!t5._statement$_closed) {
              ...
              A._asInt(t6.bindings.sqlite3.sqlite3_finalize(t6.stmt));
            }
            t6 = t4.database;
            t3._as(t4);
            if (!t6._isClosed)
    ...
    _getPreparedStatement$1(sql) {
      ...
      if (A._asInt(t2.sqlite3_stmt_isexplain(t3)) === 0) {
        if (t1.__js_helper$_length === 64)
          t1.remove$1(0, new A.LinkedHashMapKeysIterable(t1, A._instanceType(t1)._eval$1("LinkedHashMapKeysIterable<1>")).get$first(0)).dispose$0();
        t1.$indexSet(0, sql, stmt);
      }
      return new A._Record_2(stmt, A._asInt(t2.sqlite3_stmt_isexplain(t3)) === 0);
    }
  };
  ...
  A.PreparedStatementsCache.prototype = {
    disposeAll$0() {
      var t1, t2, t3, t4, t5;
      for (t1 = this._cachedStatements, t2 = new A.LinkedHashMapValueIterator(t1, t1.__js_helper$_modifications, t1.__js_helper$_first, A._instanceType(t1)._eval$1("LinkedHashMapValueIterator<2>")); t2.moveNext$0();) {
        t3 = t2.__js_helper$_current;
        t4 = t3.finalizable;
        if (!t4._statement$_closed) {
          t5 = $.$get$disposeFinalizer()._registry;
          if (t5 != null)
            t5.unregister(t3);
          if (!t4._statement$_closed) {
            t4._statement$_closed = true;
            if (!t4._inResetState) {
              t5 = t4.statement;
              A._asInt(t5.bindings.sqlite3.sqlite3_reset(t5.stmt));
              t4._inResetState = true;
            }
            t5 = t4.statement;
            t5.deallocateArguments$0();
            A._asInt(t5.bindings.sqlite3.sqlite3_finalize(t5.stmt));
          }
          t3 = t3.database;
          if (!t3._isClosed)
            B.JSArray_methods.remove$1(t3.finalizable._statements, t4);
        }
      }
      t1.clear$0(0);
    }
  ...
  A.LazyDatabase.prototype = {
    ...
    get$dialect() {
      if (this._delegateAvailable) {
        ...
        t1 = false;
      if (t1)
        throw A.wrapException(A.Exception_Exception("LazyDatabase created with " + B.SqlDialect_0_sqlite.toString$0(0) + ", but underlying database is " + this.get$_lazy_database$_delegate().get$dialect().toString$0(0) + "."));
      return B.SqlDialect_0_sqlite;
    },
    _awaitOpened$0() {
      ...
      var $async$close$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = $async$self._delegateAvailable ? 3 : 5;
              break;
            case 3:
              // then
              t1 = $async$self.__LazyDatabase__delegate_F;
              t1 === $ && A.throwLateFieldNI("_delegate");
              $async$goto = 6;
            ...
            case 5:
              // else
              _0_0 = $async$self._openDelegate;
              $async$goto = _0_0 != null ? 7 : 8;
              break;
            case 7:
              // then
              $async$goto = 9;
              return A._asyncAwait(_0_0.future, $async$close$0);
            case 9:
              // returning from await.
              t1 = $async$self.__LazyDatabase__delegate_F;
              t1 === $ && A.throwLateFieldNI("_delegate");
  ...
  A.Lock.prototype = {
    synchronized$1$1(block, $T) {
      var previous, blockReleasedLock, t1;
      $T._eval$1("0/()")._as(block);
      previous = this._synchronized$_last;
      blockReleasedLock = new A._Future($.Zone__current, type$._Future_void);
      this._synchronized$_last = blockReleasedLock;
      t1 = new A.Lock_synchronized_callBlockAndComplete(this, block, new A._AsyncCompleter(blockReleasedLock, type$._AsyncCompleter_void), blockReleasedLock, $T);
      if (previous != null)
  ...
  A.Lock_synchronized_callBlockAndComplete_closure.prototype = {
    call$0() {
      this.blockCompleted.complete$0();
      var t1 = this.$this;
  ...
  A.WebPortToChannel_channel_closure.prototype = {
    call$1($event) {
      var message = A._asJSObject($event).data,
  ...
  A.WebPortToChannel_channel_closure0.prototype = {
    call$1(e) {
      this._this.postMessage(A.jsify(e));
    },
    $signature: 4
  };
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$returnValue = A._asInt(A._asDouble(init.G.Number(type$.JavaScriptBigInt._as(t1.bindings.sqlite3.sqlite3_last_insert_rowid(t1.db)))));
              // goto return
              $async$goto = 1;
              break;
            case 1:
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              // returning from await.
              t1 = $async$self._database.database;
              $async$returnValue = A._asInt(t1.bindings.sqlite3.sqlite3_changes(t1.db));
              // goto return
              $async$goto = 1;
              break;
            case 1:
          ...
          switch ($async$goto) {
            case 0:
              ...
              if (message != null && A.JSAnyUtilityExtension_instanceOfString(message, "MessagePort")) {
                ...
                server.serve$1(A.WebPortToChannel_channel(A._asJSObject(message)));
              } else
  ...
  A.FinalizableDatabase.prototype = {
    dispose$0() {
      ...
      for (t1 = _this._statements, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        stmt = t1[_i];
        if (!stmt._statement$_closed) {
          stmt._statement$_closed = true;
  ...
  A.DatabaseImplementation.prototype = {
    get$userVersion() {
      ...
      try {
        result = stmt.selectWith$1(new A.IndexedParameters(B.List_empty2));
    ...
    createFunction$5$argumentCount$deterministic$directOnly$function$functionName(argumentCount, deterministic, directOnly, $function, functionName) {
      ...
      type$.nullable_Object_Function_SqliteArguments._as($function);
      t1 = this.database;
      ...
      t2 = t4.sqlite3;
      result = A.callMethod(t2, "dart_sqlite3_create_scalar_function", [t1.db, ptr, argumentCount.allowedArgs, flags, t4.callbacks.register$1(new A.RegisteredFunctionSet(t3, _null, _null))], type$.int);
      result = result;
      t2.dart_sqlite3_free(ptr);
      if (result !== 0)
  ...
  A.DatabaseImplementation__prepareInternal_freeIntermediateResults.prototype = {
    call$0() {
      ...
      for (t1 = this.createdStatements, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        stmt = t1[_i];
        t3 = stmt.finalizable;
        if (!t3._statement$_closed) {
          t4 = $.$get$disposeFinalizer()._registry;
          if (t4 != null)
            t4.unregister(stmt);
          if (!t3._statement$_closed) {
            t3._statement$_closed = true;
            if (!t3._inResetState) {
              t4 = t3.statement;
  ...
  A.ValueList.prototype = {
    ...
    $index(_, index) {
      ...
      if (0 > index || index >= $length)
        A.throwExpression(A.IndexError$withLength(index, $length, this, null, "index"));
      t2 = this._cachedCopies;
      if (!(index >= 0 && index < t2.length))
        return A.ioore(t2, index);
      t3 = t2[index];
      if (t3 == null) {
        t1 = A.ReadDartValue_read(t1.$index(0, index));
        B.JSArray_methods.$indexSet(t2, index, t1);
      } else
        t1 = t3;
      return t1;
    },
  ...
  A.Sqlite3Implementation.prototype = {
    open$2$vfs(filename, vfs) {
      var namePtr, t3, outDb, result, t4, t5, dbPtr, exception, _null = null,
        t1 = this.bindings,
        t2 = t1.bindings,
      ...
      t2 = new A.WasmDatabase0(t2, dbPtr);
      if (result !== 0) {
    ...
    open$1(filename) {
      return this.open$2$vfs(filename, null);
    },
    $isCommonSqlite3: 1
  };
  ...
  A.StatementImplementation.prototype = {
    ...
    _readValue$1(index) {
      ...
      switch (A._asInt(t3.sqlite3_column_type(t1, index))) {
        ...
        case 3:
          return A.WrappedMemory_readString(t2.memory, A._asInt(t3.sqlite3_column_text(t1, index)), null);
        case 4:
          $length = A._asInt(t3.sqlite3_column_bytes(t1, index));
          return A.WrappedMemory_copyRange(t2.memory, A._asInt(t3.sqlite3_column_blob(t1, index)), $length);
        case 5:
        default:
          return null;
      }
    ...
    _bindParam$2(param, i) {
      ...
      $label0$0: {
        ...
        if (param instanceof A._BigIntImpl) {
          t1 = _this.statement;
          t1 = A._asInt(t1.bindings.sqlite3.sqlite3_bind_int64(t1.stmt, i, type$.JavaScriptBigInt._as(init.G.BigInt(A.BigIntRangeCheck_get_checkRange(param).toString$0(0)))));
          break $label0$0;
        }
        if (A._isBool(param)) {
          t1 = _this.statement;
    ...
    selectWith$1(parameters) {
      var _this = this;
      if (_this.finalizable._statement$_closed)
        A.throwExpression(A.StateError$(string$.Tried_));
      _this._reset$0();
  ...
  A.WasmValueList.prototype = {
    $index(_, index) {
      var t1 = this.bindings,
        t2 = A.NativeInt32List_NativeInt32List$view(type$.NativeArrayBuffer._as(t1.memory.buffer), 0, null),
        t3 = B.JSInt_methods._shrOtherPositive$1(this.value + index * 4, 2);
      if (!(t3 < t2.length))
        return A.ioore(t2, t3);
      return new A.WasmValue(t1, t2[t3]);
    },
    $indexSet(_, index, value) {
  ...
  A._InjectedValues_closure0.prototype = {
    call$5(vfsId, zName, dartFdPtr, flags, pOutFlags) {
      ...
      t2.toString;
      t3 = this.memory;
      A.WrappedMemory_readNullableString(t3, zName, null);
      return A._runVfs(new A._InjectedValues__closure13(t1, t2, new A.Sqlite3Filename(), flags, t3, dartFdPtr, pOutFlags));
    },
    $signature: 31
  };
  A._InjectedValues__closure13.prototype = {
    call$0() {
      ...
      _this.vfs.xOpen$2(_this.path, _this.flags);
      t1 = _this.$this.callbacks;
      t2 = A.assertUnreachable();
      t3 = t1._id++;
      t1.openedFiles.$indexSet(0, t3, t2);
      t2 = _this.memory;
      t1 = type$.NativeArrayBuffer;
      t4 = A.NativeInt32List_NativeInt32List$view(t1._as(t2.buffer), 0, null);
      ...
      t3 = _this.pOutFlags;
      if (t3 !== 0) {
        t4 = A.assertUnreachable();
        B.NativeInt32List_methods.$indexSet(A.NativeInt32List_NativeInt32List$view(t1._as(t2.buffer), 0, null), B.JSInt_methods._shrOtherPositive$1(t3, 2), t4);
      }
    },
    $signature: 0
  };
  ...
  A._InjectedValues__closure11.prototype = {
    call$0() {
      ...
      B.NativeInt32List_methods.$indexSet(A.NativeInt32List_NativeInt32List$view(type$.NativeArrayBuffer._as(_this.memory.buffer), 0, null), B.JSInt_methods._shrOtherPositive$1(_this.pResOut, 2), res);
    },
    $signature: 0
  };
  ...
  A._InjectedValues__closure10.prototype = {
    call$0() {
      var t2, t3, _this = this,
        ...
        t1 = encoded.length;
      if (t1 > _this.nOut)
        throw A.wrapException(new A.VfsException(14));
  ...
  A._InjectedValues__closure9.prototype = {
    call$0() {
      var t1 = A.BaseVirtualFileSystem_generateRandomness(A.NativeUint8List_NativeUint8List$view(type$.NativeArrayBuffer._as(this.memory.buffer), this.zOut, this.nByte));
      return t1;
    },
    $signature: 0
  };
  ...
  A._InjectedValues_closure6.prototype = {
    call$2(vfsId, target) {
      ...
      A._asInt(vfsId);
      A._asInt(target);
      t1 = type$.JavaScriptBigInt._as(init.G.BigInt(this.$this.callbacks.registeredVfs.$index(0, vfsId).xCurrentTime$0().get$millisecondsSinceEpoch()));
  ...
  A._InjectedValues__closure2.prototype = {
    call$0() {
      ...
      B.NativeInt32List_methods.$indexSet(A.NativeInt32List_NativeInt32List$view(type$.NativeArrayBuffer._as(this.memory.buffer), 0, null), B.JSInt_methods._shrOtherPositive$1(this.sizePtr, 2), size);
    },
    $signature: 0
  };
  ...
  A._InjectedValues__closure.prototype = {
    call$0() {
      ...
      B.NativeInt32List_methods.$indexSet(A.NativeInt32List_NativeInt32List$view(type$.NativeArrayBuffer._as(this.memory.buffer), 0, null), B.JSInt_methods._shrOtherPositive$1(this.pResOut, 2), $status);
    },
    $signature: 0
  };
  A._InjectedValues_closure17.prototype = {
    call$3(ctx, args, value) {
      ...
      t2 = t1.callbacks.functions.$index(0, A._asInt(t2.sqlite3.sqlite3_user_data(ctx))).xFunc;
  ...
  A._InjectedValues_closure18.prototype = {
    call$3(ctx, args, value) {
      ...
      t2 = t1.___InjectedValues_bindings_A;
      t2 === $ && A.throwLateFieldNI("bindings");
      t2 = t1.callbacks.functions.$index(0, A._asInt(t2.sqlite3.sqlite3_user_data(ctx))).xStep;
      t1 = t1.___InjectedValues_bindings_A;
      t2.call$2(new A.WasmContext(t1, ctx), new A.WasmValueList(t1, args, value));
    },
    $signature: 15
  ...
  A.main_closure.prototype = {
    call$0() {
      return new A.LazyDatabase(new A.main__closure());
    },
    $signature: 73
  };
  A.main__closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.WasmDatabase),
        $async$returnValue, sqlite3, t1;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.WasmSqlite3_loadFromUrl(A.Uri_parse("sqlite3.wasm")), $async$call$0);
            case 3:
              // returning from await.
              sqlite3 = $async$result;
              t1 = A.LinkedHashMap_LinkedHashMap(type$.String, type$.CommonPreparedStatement);
              $async$returnValue = new A.WasmDatabase(new A._WasmDelegate(sqlite3, "/vacuno_db", null, null, true, true, new A.PreparedStatementsCache(t1)), false, true, new A.Lock(), new A.Lock());
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "math__sqrt$closure", "sqrt", 3);
    _static_1(A, "math__sin$closure", "sin", 3);
    _static_1(A, "math__cos$closure", "cos", 3);
    _static_1(A, "math__tan$closure", "tan", 3);
    _static_1(A, "math__acos$closure", "acos", 3);
    _static_1(A, "math__asin$closure", "asin", 3);
    _static_1(A, "math__atan$closure", "atan", 3);
    _instance_1_u(A.DriftCommunication.prototype, "get$_communication$_handleMessage", "_communication$_handleMessage$1", 4);
    _instance_1_u(A.DriftProtocol.prototype, "get$_decodeDbValue", "_decodeDbValue$1", 16);
    _static_1(A, "delegates___defaultSavepoint$closure", "_defaultSavepoint", 12);
    _static_1(A, "delegates___defaultRelease$closure", "_defaultRelease", 12);
    _static_1(A, "delegates___defaultRollbackToSavepoint$closure", "_defaultRollbackToSavepoint", 12);
    _static_1(A, "native_functions___pow$closure", "_pow", 33);
    _static_1(A, "native_functions___regexpImpl$closure", "_regexpImpl", 93);
    _static_1(A, "native_functions___containsImpl$closure", "_containsImpl", 94);
    _instance_1_u(_ = A._RunningDriftWorker.prototype, "get$_newConnection", "_newConnection$1", 18);
  ...
  (function inheritance() {
    ...
    _inheritMany(A._Enum, [A.NoArgsRequest, A.StatementMethod, A.NestedExecutorControl, A.UpdateKind, A.SqlDialect, A.ProtocolVersion, A.DriftWorkerMode, A.OpenMode]);
    ...
    _inheritMany(A.QueryExecutor, [A._BaseExecutor, A.LazyDatabase]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "int(int,int)", "double(num)", "~(Object?)", "Null()", "Frame()", "Null(int)", "Frame(String)", "~(@)", "int(int)", "Future<~>()", "String(int)", "~(~())", "~(Object,StackTrace)", "Null(int,int,int)", "Object?(Object?)", "int(int,int,int)", "~(JSObject)", "Null(@)", "~(Object[StackTrace?])", "Null(Object,StackTrace)", "bool()", "String(Frame)", "int(Frame)", "Trace(String)", "@()", "int(int,int,int,JavaScriptBigInt)", "int(int,int,int,int)", "String(String)", "int?(int)", "int(int,int,int,int,int)", "bool(~)", "num?(List<Object?>)", "Future<int>()", "Future<Null>()", "int()", "Future<bool>()", "Map<String,@>(List<Object?>)", "int(List<Object?>)", "Future<QueryResult>()", "Null(QueryExecutor)", "Future<bool>(~)", "Null(JSObject)", "Future<ResponsePayload?>()", "Object?(JSObject)", "StreamChannel<Object?>()", "SubscriptionStream<Object?>(Stream<Object?>)", "CancellationToken<@>?()", "String(String?)", "String(Object?)", "~(RawSqliteContext,List<RawSqliteValue>)", "~(FinalizablePart)", "~(String,Map<String,Object?>)", "~(String,Object?)", "ResponsePayload?/(Request)", "Null(~)", "Future<~>(Request)", "0&(String,int?)", "Null(int,int)", "@(String)", "int(int,JavaScriptBigInt)", "~(Object?,Object?)", "Null(int,int,int,int,JavaScriptBigInt)", "~(@,@)", "List<Frame>(Trace)", "int(Trace)", "~(@,StackTrace)", "String(Trace)", "@(@,String)", "Null(bool)", "Frame(String,String)", "Trace()", "LazyDatabase()", "Future<WasmDatabase>()", "~(int,@)", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "0^(0^,0^)<num>", "Null(@,StackTrace)", "@(@)", "bool?(List<Object?>)", "bool?(List<@>)", "Null(~())", "Null(JavaScriptBigInt,int)"],
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      Record_0: findType("+()"),
      Record_2_nullable_Object_and_int: findType("+(Object?,int)"),
      ...
      WasmDatabase: findType("WasmDatabase"),
      ...
      nullable_Object_Function_SqliteArguments: findType("Object?(SqliteArguments)"),
...
;
    ...
    B.List_empty1 = makeConstList([], type$.JSArray_List_nullable_Object);
    B.List_empty2 = makeConstList([], type$.JSArray_Object);
    ...
    B.List_empty3 = makeConstList([], type$.JSArray_Map_of_String_and_nullable_Object);
    B.SelectResult_List_empty = new A.SelectResult(B.List_empty3);
